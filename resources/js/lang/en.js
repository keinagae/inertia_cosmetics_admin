export default {
  ...
  roles: {
    description: {
      ...
      'admin User': 'Administrator. Have access and full permission to Some Management pages.',
      seller: 'Product Seller. Have access and permission to most of pages for selling product detail.',
      business: 'Business Customer. Have access and permission to most of pages for business detail.',
      'shop Owner': 'Permission for Shop Owner & Independent Account',
