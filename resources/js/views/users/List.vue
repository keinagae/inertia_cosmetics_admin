<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="users" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column align="center" label="Role" width="120">
        <template slot-scope="scope">
          <span>Roles Not implemented Yet</span>
<!--          <span>{{ scope.row.roles.join(', ') }}</span>-->
        </template>
      </el-table-column>

      <el-table-column align="center" label="Subscription" width="120">
        <template slot-scope="scope">
          <span>Premium</span>
        </template>
      </el-table-column>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      users:[],
      roles: ['admin', 'admin User', 'seller', 'business', 'shop Owner'],
      nonAdminRoles: ['admin User', 'seller', 'business', 'shop Owner'],
      newUser: {},
